...
window_main.geometry("1200x800+10+10") # Fensterbreite,hoehe, on secreen offset x, on screen offset y
...
lable_text = tk.Label(text="Projekt Title ",foreground="green",background="black", font=("Helvetica", 30))
...
lable_text = tk.Label(text="Measurment Settings ",foreground="green",background="white", font=("Helvetica", 15))
...
freq_start_input.place(x = 200, y = 100, width=input_width, height=text_input_height)
...
freq_step_input.place(x = 200, y = 200, width=input_width, height=text_input_height)
...
button_run = tk.Button(window_main, text = "RUN measurment", command = RUN,foreground="green")
button_run.place(x = 50, y = 300, width=200, height=50)

######----- Tune&Match Settings ------######
lable_text = tk.Label(text="Tune&Match Settings",foreground="green",background="white", font=("Arial Bold", 15))
...
Tune_U_max_input.place(x = 600, y = 100, width=input_width, height=text_input_height)
...
Match_U_max_input.place(x = 600, y = 150, width=input_width, height=text_input_height)
...
send_TMfile = tk.Button(window_main, text = "Send TM-file", command = RUN,foreground="green")
...
file_path_input.place(x = 1000, y = 300, width=input_width, height=text_input_height)
...
button_run = tk.Button(window_main, text = "RUN", command = RUN,foreground="green")
button_run.place(x = 550, y = butons_y, width=150, height=50)

button_val = tk.Button(window_main, text = "variable_input_win", command =lambda:  Varify_meas_set("HI"),foreground="red")
