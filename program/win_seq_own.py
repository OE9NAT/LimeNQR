...
def windows_file(path="test_data", experiment="test_experiment", cycle="test_cycle"):
    ...
    update_button = tk.Button(window_puls, text="Update puls",
                              background="green4", command=lambda:  nr_puls(int(slidebar.get())))
...
if __name__ == "__main__":
    ...
    print("test")
    windows_file(path="test_data", experiment="test_experiment_3",
                 cycle="test_cycle_3")
