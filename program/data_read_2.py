...
def plot(filename):
    ...
    font_plot = {'family': 'serif','color':  'darkred','weight': 'normal','size': 16}
    ...
    time = np.linspace(0, time_length, len(data), endpoint=False) # in micro sec
    ...
    plt.text(150, 150, text, fontdict={'family': 'serif','weight': 'normal','size': 10})
    
    save_filename = folder_signal+"/plots/"+"sample_time_" + filename[42:-4] + ".jpg"
    print("save_filename",save_filename)
    plt.savefig(save_filename)
    
    
    save_filename = folder_signal+"/plots/"+"sample_time_" + filename[42:-4] + ".svg"
    print("save_filename",save_filename)
    plt.savefig(save_filename)
    ...
    save_filename = folder_signal+"/plots/"+"sample_" + filename[42:-4] + ".jpg"
    print("save_filename",save_filename)
    plt.savefig(save_filename)
    #plt.show()
