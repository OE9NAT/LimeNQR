...
def save_values(path="test_data",experiment="test_experiment",cycle="test_cycle"): 
    ...
    config["filepath"]={"path":path,"experiment":experiment,"cycle":cycle}
    ...
    try:
        ...
        print("available of file_path ___ ", config.has_option(cfg_section, "file_path"))
        print("available of puls_sequenz ___ ", config.has_option(cfg_section, "puls_sequenz"))
...
def load_file(path="data", experiment="test_experiment",cycle="test_cycle"):
    ...
    def save_experiment():
        ...
        experiment_lable.config(text= "Seq. for experiment: "+experiment_dict["experiment"])
        cycle_lable.config(text = "Seq. for cycle: "+experiment_dict["cycle"])     
        
        
        save_values(experiment_dict["data"],experiment_dict["experiment"],experiment_dict["cycle"])
        print("end of save_experiment")
          
  
    
    #Title    
    lable_text = tk.Label(window_experiment, text="Set Experiment strukture ",foreground="green",background="OliveDrab4", font=("Helvetica", 30))
    ...
    path_lable = tk.Label(window_experiment,text=path_text, background="gray50")
    path_lable.place(x = 50, y = 100, width=500, height=text_input_height)
    
    experiment_text = "Seq. for experiment: "+experiment
    experiment_lable = tk.Label(window_experiment,text=experiment_text, background="gray50")
    experiment_lable.place(x = 50, y = 150, width=500, height=text_input_height)
    
    cycle_text = "Seq. for cycle: "+cycle
    cycle_lable = tk.Label(window_experiment,text=cycle_text, background="gray50")
    cycle_lable.place(x = 50, y = 200, width=500, height=text_input_height)
    
       
    # Experiment
    gray_light = "gray70"
    path_lable_input = tk.Label(window_experiment,text="Set Seq. data: ", background=gray_light)
    ...
    experiment_lable_input = tk.Label(window_experiment,text="Set Seq. experiment: ", background=gray_light)
    ...
    cycle_lable_input = tk.Label(window_experiment,text="Set Seq. cycle: ", background=gray_light)
    ...
    # Buttons
    save_button = tk.Button(window_experiment, text="Save", background="SkyBlue4", command=lambda:  save_experiment())
    save_button.place(x = 50, y = 450, width=140, height=50)
    
    save_button = tk.Button(window_experiment, text="load", command=lambda:  print("butten load"))
    save_button.place(x = 230, y = 450, width=140, height=50)
    
    close_button = tk.Button(window_experiment, text="Close",background="tomato4", command=window_experiment.destroy)
...
def windows_file(path="test_data", experiment="test_experiment",cycle="test_cycle"):
    ...
    def nr_puls(cycle):
        ...
        for i,puls in enumerate(pulses):
            ...
            experiment_lable = tk.Label(window_puls,text=lable_puls, background="gray60")
            experiment_lable.place(x = x_pos, y = puls_y, width=50, height=text_input_height)
    ...
    #Title    
    lable_text = tk.Label(window_puls, text="Set Puls sequenz ",foreground="green",background="gray70", font=("Helvetica", 30))
    ...
    experiment_lable = tk.Label(window_puls,text=experiment_text, background="gray60")
    ...
    cycle_lable = tk.Label(window_puls,text="number of \n pulses", background="gray60")
    cycle_lable.place(x = 40, y = 160, width=80, height=60)  
    
    #Puls_number = tk.Entry(window_puls,fg="black", bg="white", width=40)
    #Puls_number.insert(10,"4")
    #Puls_number.place(x = 40, y = 240, width=80, height=text_input_height)
    
    slidebar = tk.Scale(window_puls, from_=2, to=10, orient=tk.HORIZONTAL)
    slidebar.set(2)
    slidebar.place(x = 40, y = 230, width=80, height=100)
    
    update_button = tk.Button(window_puls, text="Update puls",background="green4", command=lambda:  nr_puls(int(slidebar.get())))
    update_button.place(x = 40, y = 280, width=80, height=50)  
   

    
    ### picture
   
    image_path = "sequenz/puls_seq.JPG"
    image = Image.open(image_path) 
    image_puls = image.resize((750, 200))
    image_puls = ImageTk.PhotoImage(image_puls)
    ...
    P_1_lable.place(x = 50, y = 400, width=90, height=text_input_height) 
    simple_label(unit_puls,235,400)

    globals()["P_1_input"] = tk.Entry(window_puls,fg="black", bg="white", width=40)
    P_1_input.place(x = 150, y = 400, width=input_width, height=text_input_height)
    
    # TP_1
    TP_1_lable = tk.Label(window_puls,text="TP 1: ",background="gray50")
    TP_1_lable.place(x = 50, y = 450, width=90, height=text_input_height) 
    simple_label(unit_puls,235,450)

    globals()["TP_1_input"] = tk.Entry(window_puls,fg="black", bg="white", width=40)
    TP_1_input.place(x = 150, y = 450, width=input_width, height=text_input_height)
    
    # TA
    TA_lable = tk.Label(window_puls,text="TA: ",background="gray50")
    TA_lable.place(x = 50, y = 500, width=90, height=text_input_height) 
    simple_label(unit_puls,235,500)

    globals()["TA_input"] = tk.Entry(window_puls,fg="black", bg="white", width=40)
    TA_input.place(x = 150, y = 500, width=input_width, height=text_input_height)
    
    # P_2
    P_2_lable = tk.Label(window_puls,text="P 2: ",background="gray50")
    P_2_lable.place(x = 300, y = 400, width=90, height=text_input_height) 
    simple_label(unit_puls,(300+185),400)

    globals()["P_2_input"] = tk.Entry(window_puls,fg="black", bg="white", width=40)
    P_2_input.place(x = 400, y = 400, width=input_width, height=text_input_height)
    
    # TP_2
    TP_2_lable = tk.Label(window_puls,text="TP 2: ",background="gray50")
    TP_2_lable.place(x = 300, y = 450, width=90, height=text_input_height) 
    simple_label(unit_puls,(300+185),450)

    globals()["TP_2_input"] = tk.Entry(window_puls,fg="black", bg="white", width=40)
    TP_2_input.place(x = 400, y = 450, width=input_width, height=text_input_height)
    
    # P_3
    P_3_lable = tk.Label(window_puls,text="P 3: ",background="gray50")
    P_3_lable.place(x = 550, y = 400, width=90, height=text_input_height) 
    simple_label(unit_puls,(550+185),400)

    globals()["P_3_input"] = tk.Entry(window_puls,fg="black", bg="white", width=40)
    P_3_input.place(x = 650, y = 400, width=input_width, height=text_input_height)
    
    # TP_3
    TP_3_lable = tk.Label(window_puls,text="TP 3: ",background="gray50")
    TP_3_lable.place(x = 550, y = 450, width=90, height=text_input_height) 
    simple_label(unit_puls,(550+185),450)

    globals()["TP_3_input"] = tk.Entry(window_puls,fg="black", bg="white", width=40)
    TP_3_input.place(x = 650, y = 450, width=input_width, height=text_input_height)
    ...
    test_button = tk.Button(window_puls, text="test1", command=lambda:  print("test butten form Pulssequenz"))
    test_button.place(x = 400, y = butons_y, width=150, height=50)
    
    test2_button = tk.Button(window_puls, text="test2", command=window_puls.destroy)
    test2_button.place(x = 600, y = butons_y, width=150, height=50)
 
    close_button = tk.Button(window_puls, text="Close",background="tomato4", command=window_puls.destroy)#quit)
...
if __name__ == "__main__":
    ...
    print("test")
    windows_file(path="test_data", experiment="test_experiment_3",cycle="test_cycle_3")
