...
def windows_file(path="test_data", experiment="test_experiment",cycle="test_cycle"):
    ...
    #Title    
    lable_text = tk.Label(window_puls, text="Set Spin sequenz ",foreground="green",background="gray70", font=("Helvetica", 30))
    ...
    P_2_lable.place(x = 300, y = 500, width=90, height=text_input_height) 
    simple_label(unit_puls,(300+185),500)

    globals()["P_2_input"] = tk.Entry(window_puls,fg="black", bg="white", width=40)
    P_2_input.place(x = 400, y = 500, width=input_width, height=text_input_height)
    
    # TP_2
    TP_2_lable = tk.Label(window_puls,text="TP 2: ",background="gray50")
    TP_2_lable.place(x = 300, y = 550, width=90, height=text_input_height) 
    simple_label(unit_puls,(300+185),550)

    globals()["TP_2_input"] = tk.Entry(window_puls,fg="black", bg="white", width=40)
    TP_2_input.place(x = 400, y = 550, width=input_width, height=text_input_height)
